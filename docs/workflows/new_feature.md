...
Документация проекта живёт в `docs/`. Спецификации и результаты аудитов — в `docs/specs/`
(нумерованные документы плюс `docs/specs/README.md` со сводной таблицей), планы реализации —
в `docs/plans/`, завершённые планы переезжают в `docs/plans/completed/`.

```bash
# 1. Описать проблему и требования как новый документ в docs/specs/
#    (нумерация продолжает существующую: 001-…, 002-…, 003-…, 004-…)
$EDITOR docs/specs/005-[name].md

# 2. Добавить строку в сводную таблицу docs/specs/README.md

# 3. Превратить спецификацию в план работ — навык /planning:make
#    создаст структурированный план в docs/plans/
```
