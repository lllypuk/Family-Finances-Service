...
Планы 01–09 выполнены, `v0.1.0` поставлен 12.09.2026; контракт бюджетов после плана 09 изменился,
поэтому следующий серверный релиз — `v0.2.0`. Следующим планом — отчёты с экспортом
