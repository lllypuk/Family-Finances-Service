...
Планы 01–10 и 12–20 выполнены: сервер прошёл `v0.3.0` (план 10), `v0.4.0` (план 12) и `v0.8.0` (планы 14–18),
клиент — `app-v0.10.0`; `v0.5.0`–`v0.7.0` и `app-v0.6.0`–`app-v0.9.0` не нарезались. План 19 (клиент `0.11.0`,
