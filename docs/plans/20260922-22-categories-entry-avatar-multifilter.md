...
- [ ] аватар: эмодзи и цвет видны в операциях, листах, справочнике, главной, «Обзоре»; `default`/`food` — буква
- [ ] фильтр по двум категориям показывает операции обеих; чип «Имя +1»; переживает поворот
