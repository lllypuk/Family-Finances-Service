...
- [x] (deferred - release action requires owner approval; not performed in this run) поставить тег `v0.1.0`, убедиться, что `docker.yml` опубликовал multi-arch образ
