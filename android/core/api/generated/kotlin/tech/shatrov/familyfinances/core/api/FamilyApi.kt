...
interface FamilyApi {
     ...
     * PUT api/v1/family
     * Изменить семью
     * Только admin. Смена &#x60;currency&#x60; при наличии транзакций, остатков счетов, снимков или планов позиций запрещена — &#x60;409 CURRENCY_LOCKED&#x60; (A-05). &#x60;timezone&#x60; — IANA-имя, в нём считаются «сегодня» и границы периодов (A-06). 
     * Responses:
     *  - 200: Семья
