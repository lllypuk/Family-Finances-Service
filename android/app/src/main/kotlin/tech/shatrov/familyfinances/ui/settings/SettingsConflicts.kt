...
internal object ConflictCode {
    ...
    const val ACCOUNT_NAME_EXISTS = "ACCOUNT_NAME_EXISTS"
    const val ACCOUNT_IN_USE = "ACCOUNT_IN_USE"
}

/** Общая карта для `409` профиля, пользователей, семьи и счетов — `toUiError(known)` берёт её целиком. */
internal val settingsConflicts: Map<String, Int> = mapOf(
    ...
    ConflictCode.ACCOUNT_NAME_EXISTS to R.string.settings_error_account_name_exists,
    ConflictCode.ACCOUNT_IN_USE to R.string.settings_error_account_in_use,
)
